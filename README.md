...
- **Lightning Bolt (⚡) Icons:** Click to have the AI write descriptors, scenarios, or greetings based on the character's existing context.
...
- Real-time AI responses that respect your character's full context and V2 formatting rules.
